...
class EditQueryService
{
    public function getQuery(): array
    {
        return [
            'dstatus:id,title,color',
            'sourceInformation:id,submission_id,survey_province,district_name,surveyors_code,surveyors_name,nahya_number,kbl_guzar_number,village_name,province_code,city_name,city_code,district_code,block_number,house_number,area_representative_name,area_representative_phone',
        ...
        // house_problems_area_photos (including its nested objects)
