...
class LandUseController
{
    ...
    public function uploadShapefile(Request $request)
    {
        ...
        try {
            ...
            // Store the uploaded zip file using Storage
            $path = Storage::putFile('uploads/shapefiles', $uploadedFile);
...
public function getLandUse()
{
    ...
    /**
     * Parse shapefile using gasparesganga/php-shapefile - Simplified
     */
    private function parseShapefile($shapefilePath, $extractPath)
    {
        try {
            ...
            foreach ($shapefile as $record) {
                ...
                // Get GeoJSON and attributes directly
                $features[] = [
